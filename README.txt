...
**********************************************************************************************************************************
Driver file : clustererDriver - makefile creates executable called clusterer - to run type in terminal ./clusterer <dataset directory> OPTIONAL FLAGS : [-o output] [-k n] [-bin b] [-color] [-edgefilter1] [-edgefilter2]
...
-edgefilter1/2 : these flags implement a prewwit or sobel filter preprocessing to the image. This function only works on greyscale images and highlights edges in the images. Edgefilter1 is for prewwit filter and edgefilter2 is for sobel. To use this flag just type -edgefilter1 or -edgefilter2 after the necessary flags.
**********************************************************************************************************************************
